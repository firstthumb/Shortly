...
class GetFavShortenListUseCase implements UseCase<List<Shorten>, NoParams> {
  final ShortenRepository repository;

  GetFavShortenListUseCase({@required this.repository});

  @override
  Future<Either<Failure, List<Shorten>>> call(NoParams params) async {
    return await repository.getFavShortens();
  }
}
